...
import TimelineParcours from './TimelineParcours.jsx'
            ...
            return (
              <React.Fragment key={alumno.id}>
                <tr className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3.5">
                    {resultado?.parcours?.length > 0 && (
                      <button
                        onClick={() => setExpandido(expandido === alumno.id ? null : alumno.id)}
                        className="text-xs text-blue-600 hover:text-blue-700 font-medium"
                      >
                        {expandido === alumno.id ? 'Ocultar' : 'Ver recorrido'}
                      </button>
                    )}
                  </td>
                </tr>
