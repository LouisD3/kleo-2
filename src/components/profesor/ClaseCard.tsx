...
export default function ClaseCard({ clase }: { clase: ClaseEnriched }) {
  return (
    <Link
      ...
      className="block bg-crema-100 rounded-[28px] p-5 shadow-[inset_0_1px_3px_rgba(0,0,0,0.015)] hover:shadow-[inset_0_1px_2px_rgba(0,0,0,0.01)] hover:bg-crema-200 transition-all duration-300 animate-fade-in group"
    >
      {/* Header */}
