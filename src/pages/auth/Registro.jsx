          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="flex items-start gap-2 cursor-pointer">
              ...
              <span className="text-xs text-gray-500">
                Acepto los{' '}
                <Link to="/legal/terminos" className="underline hover:text-gray-700" target="_blank">
                  Términos de uso
                </Link>{' '}
                y el{' '}
                <Link to="/legal/privacidad" className="underline hover:text-gray-700" target="_blank">
                  Aviso de privacidad
                </Link>
              </span>
            </label>
