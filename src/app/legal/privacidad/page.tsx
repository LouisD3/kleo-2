      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="prose prose-gray prose-sm max-w-none space-y-6 text-gray-700 leading-relaxed">
          <section>
            ...
            <p>
              Kleo (en adelante "la Plataforma") es una plataforma educativa con inteligencia
              artificial destinada a profesores y alumnos de educación secundaria en México. El
              responsable del tratamiento de los datos personales es el titular de la Plataforma,
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li>
                <strong>Profesores:</strong> nombre completo, correo electrónico, nombre de escuela
                (opcional), datos de autenticación.
              </li>
              <li>
                <strong>Alumnos:</strong> nombre completo (proporcionado por el profesor), código de
                acceso generado automáticamente.
              </li>
              <li>
                <strong>Datos académicos:</strong> tareas generadas, respuestas de alumnos,
                calificaciones y retroalimentación producida por inteligencia artificial.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <li>
                Evaluar automáticamente respuestas de alumnos y proporcionar retroalimentación.
              </li>
              <li>
                Mostrar estadísticas y promedios al profesor para el seguimiento académico del
                grupo.
              </li>
          ...
          <section>
            ...
            <p>
              La Plataforma utiliza modelos de inteligencia artificial (Anthropic Claude) para
              generar preguntas y evaluar respuestas. Los datos enviados al modelo incluyen el
              contenido de la tarea y las respuestas del alumno, pero{' '}
              <strong>no incluyen datos personales identificables</strong> como nombres o correos
              electrónicos. Las respuestas generadas por la IA son orientativas y el profesor tiene
              la posibilidad de modificar las calificaciones manualmente.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              (LFPDPPP) y la Ley General de los Derechos de Niñas, Niños y Adolescentes:
            </p>
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li>
                Los datos de alumnos son proporcionados exclusivamente por el profesor, quien actúa
                como responsable dentro de su institución educativa.
              </li>
              <li>No solicitamos directamente datos personales a menores de edad.</li>
              <li>
                Los alumnos acceden mediante un código alfanumérico, sin necesidad de proporcionar
                correo electrónico ni contraseña.
              </li>
              <li>
                El profesor es responsable de contar con las autorizaciones necesarias de padres o
                tutores dentro de su institución educativa.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Anthropic. Ambos proveedores cumplen con estándares internacionales de protección de
              datos. No vendemos ni compartimos datos personales con terceros para fines
              comerciales.
            </p>
          </section>
