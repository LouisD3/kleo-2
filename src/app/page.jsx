  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="grid sm:grid-cols-2 gap-5 w-full max-w-lg">
          ...
          >
            <div className="w-12 h-12 rounded-2xl bg-gray-900 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
              <svg
                className="w-6 h-6 text-amarillo"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
          ...
          >
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              Realiza tus tareas, recibe retroalimentación instantánea y descubre tus áreas de
              mejora.
            </p>
            <div className="mt-5 flex items-center gap-1 text-sm font-semibold text-gray-900 group-hover:gap-2 transition-all">
      ...
      <footer className="text-center py-4 text-xs text-gray-400 space-x-3">
        ...
        <span>·</span>
        <Link href="/legal/privacidad" className="hover:text-gray-600 transition-colors">
          Privacidad
        </Link>
        <Link href="/legal/terminos" className="hover:text-gray-600 transition-colors">
          Términos
        </Link>
      </footer>
    </div>
